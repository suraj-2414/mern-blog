const BlogCard = () => {
  return (
    <div className=" flex  gap-8 md:gap-16 lg:gap-20 overflow-x-auto px-6 md:px-12  lg:px-16  ">
      ...
      <div className=" w-38 h-full md:w-45 lg:w-70 shrink-0  pb-4 rounded-lg md:rounded-xl shadow-xl backdrop-blur-lg overflow-hidden bg-white">
        <div
        ...
        <p className=" hidden md:block px-2 md:pb-6 md:px-4 md:pl-4 md:pr-8 py-1 font-medium text-xs md:text-sm text-zinc-600">
      ...
      <div className=" w-38 h-full md:w-45 lg:w-70 shrink-0 pb-4 rounded-lg md:rounded-xl shadow-xl backdrop-blur-lg overflow-hidden bg-white">
        ...
        <p className=" hidden md:block px-2 pb-5  md:px-4 md:pl-4 md:pr-8 py-1 font-medium text-xs md:text-sm text-zinc-600">
