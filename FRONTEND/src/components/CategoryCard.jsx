          ...
          {/* TECH */}
           <Link to ='/blog'>
            <button onClick={()=>{
             ...
             className='active:shadow-xl '>
              <div className='TECH relative h-22 w-22 md:h-27 md:w-30 lg:h-50 lg:w-60  bg-cover bg-no-repeat   bg-center 
           ...
           {/* TRAVEL */}
            ...
            <Link to='/blog'>
             ...
             className='active:shadow-xl '>
               <div className=' LIFESTYLE relative  h-22 w-22 md:h-27 md:w-30 lg:h-50 lg:w-60   bg-cover bg-no-repeat   bg-center
           ...
           <button onClick={()=>{
             ...
             className='active:shadow-xl '>
             <div className=' DESIGN  relative  h-22 w-22 md:h-27 md:w-30 lg:h-50 lg:w-60 bg-cover bg-no-repeat   bg-center
